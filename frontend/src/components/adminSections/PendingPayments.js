...
const PendingPayments = () => {
  ...
  const fetchPayments = async () => {
    try {
      ...
      const response = await axios.get('https://rifascai.com/api/payments/pending', {
        headers: {
  ...
  const handleConfirmPayment = async (paymentId) => {
    try {
      ...
      const response = await axios.post(
        `https://rifascai.com/api/payments/${paymentId}/confirm`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleRejectPayment = async (paymentId, reason) => {
    try {
      ...
      const response = await axios.post(
        `https://rifascai.com/api/payments/${paymentId}/reject`,
        { 
