  ...
  const fetchDashboardData = useCallback(async () => {
    try {
      ...
      const [statsResponse, rafflesResponse, pendingPaymentsResponse] = await Promise.all([
        axios.get('https://rifascai.com/api/payments/stats', { headers }),
        axios.get('https://rifascai.com/api/raffle/all', { headers }),
        axios.get('https://rifascai.com/api/payments/pending', { headers }), // Fetch pending payments
      ]);
